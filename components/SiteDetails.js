    ...
    <PageTransition className='layout'>
      <motion.div layout>
        ...
        >
          ...
          <motion.p layout variants={itemVariants}>The design/css for this site was originally from an exercise in building a &lsquo;classless&rsquo; css system. I based it on Mega Man 2, and it uses the original NES color palette.</motion.p>
